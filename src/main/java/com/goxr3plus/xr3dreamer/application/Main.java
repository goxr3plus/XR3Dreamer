package main.java.com.goxr3plus.xr3dreamer.application;
...
import main.java.com.goxr3plus.xr3dreamer.controllers.RootController;
import main.java.com.goxr3plus.xr3dreamer.controllers.TopBar;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		window.setTitle("XR3Dreamer V." + RunTimeVars.APPLICATION_VERSION);
	...
	private void initControllers() {
		...
		// TopBar
		topBar = new TopBar();
		topBar.setTitle(window.getTitle());
